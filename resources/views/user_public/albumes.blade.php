    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav gap-2 text-center mt-2 mb-2 me-3">
                <li class="nav-item">
                    <a class="nav-link fw-bolder  text-white" 
                        href="{{ url('/artistas_public') }}">ARTISTAS</a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link  fw-bolder" style="color:rgb(0, 216, 86)"  href="{{ url('/albumes_public') }}">ÁLBUMES</a>
                </li>
                <li class="nav-item">
            ...
            @foreach ($albumes as $album)
                <div class="col-md-3 mt-2 col-sm-6">
                    <div class="card  me-1 ms-1" >
                        <img class="card-img-top" src="data:image/jpeg;base64,{{ $album['imagen'] }}">
                        <div class="card-body">
                            <h5 class="card-title">{{$album->titulo}}</h5>
                            <p class="card-text">Duración:  {{  gmdate("i", $album['duracion'])  }} min y {{gmdate("s", $album['duracion']) }} s</p>

                            <a class="btn btn-primary" href="{{ url('/albumes_public/' . $album->id . '/edit') }}">Ver mas</a>
                        </div>
                    </div>
                </div>
            @endforeach
