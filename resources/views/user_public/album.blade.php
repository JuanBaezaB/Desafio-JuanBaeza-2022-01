            ...
            <ul class="navbar-nav gap-2 text-center mt-2 mb-2 me-3">
                ...
                <li class="nav-item ">
                    <a class="nav-link  fw-bolder" style="color:rgb(0, 216, 86)"
                        href="{{ url('/albumes_public') }}">ÁLBUMES</a>
                </li>
                <li class="nav-item">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <h1 class="card-title">{{ $album->titulo }}</h1>
                            @foreach ($artistas as $artista)
                                @if ($artista['id'] == $album['artista_id'])
                                    <p class="card-text">Artista: {{ $artista['nombre'] }}</p>
                                @endif
                            @endforeach
                            <p class="card-text">Duración: {{ gmdate('i', $album['duracion']) }} min y
                                {{ gmdate('s', $album['duracion']) }} s</p>

                            <p class="card-text"><small class="text-muted">Fecha de lanzamiento:
                                    {{ $album->fecha_lanzamiento }}</small></p>
                        </div>
                    </div>
                </div>
            </div>
